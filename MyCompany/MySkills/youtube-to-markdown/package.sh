#!/usr/bin/env sh
# Package the youtube-to-markdown skill into a portable zip archive.
#
# Usage:
...
SKILL_NAME="youtube-to-markdown"
VERSION="${1:-}"
...
cp "$SCRIPT_DIR/scripts/transcript.ts" "$SKILL_STAGING/scripts/transcript.ts"
